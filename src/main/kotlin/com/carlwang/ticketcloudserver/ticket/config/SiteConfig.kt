...
import com.carlwang.ticketcloudserver.ticket.domain.TicketLevel
import com.carlwang.ticketcloudserver.ticket.domain.Tower
...
object TicketConfig {
    val ticketInfos = listOf(
        ...
        TicketInfo(TicketLevel("A", 220.00), listOf("109","110","111","112","113","125", "126", "130", "131"), Tower("FIRST", "首层看台")),
        TicketInfo(TicketLevel("B", 180.00), (101..108).map { it.toString() }.toList()+listOf("513", "514", "515","531","532"), Tower("FIRST", "首层看台")),
        TicketInfo(
        ...
        TicketInfo(
            ...
            listOf("508", "510", "518", "520", "526", "528"),
            Tower("SECOND", "顶层看台")
        ),
        TicketInfo(
